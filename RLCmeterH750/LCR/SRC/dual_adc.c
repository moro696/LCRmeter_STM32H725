...
ALIGN_32BYTES (static uint32_t   aADCDualConvertedValues[ADCCONVERTEDVALUES_BUFFER_SIZE]);
...
static void ADC_Config(void)
{
    ...
    AdcHandle_master.Init.ClockPrescaler        = ADC_CLOCK_ASYNC_DIV2;//ADC_CLOCK_ASYNC_DIV4;          // Asynchronous clock mode, input ADC clock divided by 4
...
void ADC_InitVREFBUF()
{
    ...
    HAL_SYSCFG_VREFBUF_VoltageScalingConfig(SYSCFG_VREFBUF_VOLTAGE_SCALE0); //2.5V
   // HAL_SYSCFG_VREFBUF_VoltageScalingConfig(SYSCFG_VREFBUF_VOLTAGE_SCALE1);//2.048
